"""
Cached attention layer for simple fast inference.

This module provides an attention layer with simple KV caching for fast inference.
"""
...
class CachedAttention(nn.Module):
    ...
    def __init__(self, config, kv_cache: 'SimpleKVCache'):
        ...
        Args:
            ...
            kv_cache: Simple KV cache instance
        """
        super().__init__()
